...
- 在重力环境下由人生下的孩子都具备初始性别，寿命因复杂环境原因为55-140岁。
- 
...
- 城市结构大类：1.基础(BASIC) 2.民生(PEOPLE) 3.资源(RESOURCE) 4.科技(TECH) 5.战备(WAR) 6.特殊(EX)
...
### 065 玻璃宇宙球
- 用玻璃管烧制而成的玻璃珠，内部的气泡与花纹宛如美丽的星辰。

### 066 准晶体 Quasicrystal
- 一种介于晶体和非晶体之间的固体。准晶体具有与晶体相似的长程有序的原子排列，但是准晶体不具备晶体的平移对称性。因而可以具有晶体所不允许的宏观对称性。 

### 067 统一场论 Unified Field Theory
- 于地球公历20世纪，人们成功的将电磁力GED 强核力GCD 弱核力 进行统一的数理化描述，而最后的引力在地球文明结束仍未统一描述。
- 于宇宙世纪的末期，通过搭建规模化的人工智能平台MAGI，获取了关于统一场论的碎片（fragment不完整的描述）及推测结果。
- 统一场论的碎片启发了对曲率的实用化，及对亚空间的探索。
- 根据星舰历记载，有星舰团在接触了高级外星文明后，获取了远古太初黑洞及黑洞湮灭纪元的观测数据后，完成了大统一论。
- 旗舰上的大都会的某个未激活的区块仍记载着这一重要的信息。
